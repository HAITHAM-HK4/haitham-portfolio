  ...
  return (
    <section className="about" id="about">
      ...
      <div className="about-card slide-left">
        ...
        <div className="about-info-grid">
          <div className="about-info-item">
            ...
            <span className="about-info-value">{about[`name_${lang}`] || 'Haitham Kallab'}</span>
          </div>
          <div className="about-info-item">
            <span className="about-info-label">{t('lbl-title-title')}</span>
            <span className="about-info-value">{about[`title_${lang}`] || 'Full-Stack Dev'}</span>
          </div>
          <div className="about-info-item">
          ...
          <div className="about-info-item">
            ...
            <span className="about-info-value">{about[`loc_${lang}`] || 'Latakia, Syria'}</span>
          </div>
        </div>
      ...
      <div className="about-photo slide-right">
        <img src="/haitham2.jpg" alt="Profile" className="about-photo-img" />
      </div>
    </section>
  );
}
